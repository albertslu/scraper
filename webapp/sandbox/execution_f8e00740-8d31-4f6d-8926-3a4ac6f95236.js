...
const StartupIdeaSchema = zod_1.z.object({
    startup_idea: zod_1.z.string().describe("The startup idea or concept being discussed"),
    description: zod_1.z.string().optional().describe("Detailed description or explanation of the startup idea"),
    author: zod_1.z.string().optional().describe("Username or name of the person who posted the idea"),
    timestamp: zod_1.z.string().optional().describe("When the comment or idea was posted"),
    upvotes: zod_1.z.number().optional().describe("Number of upvotes or likes the idea received"),
    category: zod_1.z.string().optional().describe("Category or industry the startup idea belongs to")
});
async function main() {
                ...
                if (loadMoreClicked) {
                    ...
                    if (newData && Array.isArray(newData)) {
                        ...
                        for (const item of newData) {
                            ...
                            const isDuplicate = results.some(existing => existing.startup_idea && validatedItem.startup_idea &&
